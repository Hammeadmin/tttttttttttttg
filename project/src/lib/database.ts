...
import type { Team, TeamMember, Organisation, 
  UserProfile, 
  Customer, 
  Lead, 
  Quote, 
...
import { LEAD_STATUS_LABELS, JOB_STATUS_LABELS, JOB_PRIORITY_LABELS, UserProfile, UserRole, EmploymentType } from '../types/database';
